        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Client_Discount_Range", "discount >= 0 AND discount <= 100");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Login_Length", "LENGTH(LOGIN) BETWEEN 3 AND 50");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_user_id_expires_at_is_revoked",
                table: "RefreshTokens",
